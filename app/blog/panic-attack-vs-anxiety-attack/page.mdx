...
If episodes keep happening, interfere with work, school, relationships, sleep, or daily activities, or lead you to avoid places and situations, consider <span data-internal="when-to-see-a-professional">when to see a professional</span>. A licensed clinician can help sort through what you are experiencing and discuss appropriate support.
