...
Les symptômes de panique peuvent être très réels et très perturbants. Un soutien peut être utile même lorsque vous parvenez à gérer votre quotidien. En savoir plus sur <span data-internal="when-to-see-a-professional">le moment où consulter un professionnel</span>.
